...
public class Interfejs {
	...
	private static void pokazKoty() {
		...
		if (kotDao.getKoty().size() > numerKota) {
			...
			System.out.println("Wybrany kot ma na imie " + wybranyKot.getImie() + ", wa¿y " + wybranyKot.getWaga()
					+ ", urodzi³ siê " + wybranyKot.getDataUrodzenia().toString() + ", a opiekuje siê nim "
					+ wybranyKot.getImieOpiekuna());
		} else {
